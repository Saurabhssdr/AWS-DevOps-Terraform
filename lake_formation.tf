...
resource "aws_lakeformation_data_lake_settings" "lake_settings" {
  admins = ["arn:aws:iam::277707122289:role/aws-service-role/securitylake.amazonaws.com/AWSServiceRoleForSecurityLake"] # Replace with your IAM Role ARN
}
...
resource "aws_lakeformation_permissions" "lake_permissions" {
  principal = "arn:aws:iam::277707122289:role/aws-service-role/securitylake.amazonaws.com/AWSServiceRoleForSecurityLake"  # Replace with IAM role
